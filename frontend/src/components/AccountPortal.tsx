...
// ── Module Marketing Data ────────────────────────────────────────────────────

interface ModuleMarketing {
  tagline: string;
  color: string;
  icon: string;
...
const MODULE_MARKETING: Record<string, ModuleMarketing> = {
  "MOD-FIN": {
    tagline: "Streamline every dollar from checkout to reconciliation",
    color: "#10b981",
    icon: "💳",
    highlights: [
      { icon: "🧾", title: "Auto-Invoice from SOAP", desc: "Line items auto-populate from clinical notes — no double entry, no missed charges" },
      { icon: "💳", title: "Integrated Payment Terminal", desc: "Card-present, Apple Pay, Google Pay, and split-tender payments with one tap" },
      { icon: "📊", title: "End-of-Day Reconciliation", desc: "One-click cash drawer close with variance detection and shift reports" },
      { icon: "🔗", title: "Accounting Sync", desc: "Real-time sync with QuickBooks Online and Xero — GL mapping, auto-categorization" },
      { icon: "📋", title: "Collections & Payment Plans", desc: "Automated past-due follow-up, flexible payment plans, and CareCredit/Scratchpay integration" },
    ],
    stat: { value: "23%", label: "reduction in missed charges reported by beta clinics" },
    cta: "Stop leaving revenue on the table",
  },
  "MOD-COM": {
    tagline: "Never miss a client touchpoint — automate every message",
    color: "#6366f1",
    icon: "💬",
    highlights: [
      { icon: "📱", title: "Two-Way SMS", desc: "Real-time text conversations with clients via Twilio — appointment confirmations, updates, and follow-ups" },
      { icon: "📧", title: "Email Campaigns", desc: "SendGrid-powered transactional and marketing emails with open/click tracking" },
      { icon: "🔔", title: "Smart Reminder Pipeline", desc: "AI-sequenced reminders: 7-day, 3-day, same-day, and no-show follow-up — fully automated" },
      { icon: "🤖", title: "Agentic Follow-Up", desc: "Post-visit care instructions, medication reminders, and wellness check-ins generated by AI" },
      { icon: "📋", title: "Digital Intake Forms", desc: "Pre-visit questionnaires sent via text — responses auto-populate into the SOAP note" },
    ],
    stat: { value: "67%", label: "of no-shows eliminated with automated reminder sequences" },
    cta: "Put your client communication on autopilot",
  },
  "MOD-INV": {
    tagline: "From reorder point to pharmacy label — fully automated",
    color: "#f59e0b",
    icon: "💊",
    highlights: [
      { icon: "📦", title: "Real-Time Stock Levels", desc: "Per-clinic drug inventory with unit tracking (tablets, mL, vials), lot numbers, and expiry alerts" },
      { icon: "🔒", title: "DEA Controlled Substance Log", desc: "Automatic Schedule II–V logging with perpetual inventory, reconciliation alerts, and ARCOS export" },
      { icon: "🤖", title: "Smart Reorder Agent", desc: "AI calculates reorder points from 8-week rolling usage, drafts POs to preferred distributors" },
      { icon: "🏷️", title: "Pharmacy Dispensing Workflow", desc: "Rx → dispense work order → label generation → inventory decrement → owner notification" },
      { icon: "🔗", title: "Distributor Integration", desc: "Direct connections to Covetrus, MWI, and Patterson for live pricing and automated purchase orders" },
    ],
    stat: { value: "$18K", label: "average annual savings from reduced waste and optimized ordering" },
    cta: "Eliminate stockouts and expired inventory",
  },
  "MOD-TEL": {
    tagline: "Extend your practice beyond four walls",
    color: "#ec4899",
    icon: "📹",
    highlights: [
      { icon: "🎥", title: "HD Video Consultations", desc: "HIPAA-compliant video calls with screen sharing, in-visit photo capture, and recording" },
      { icon: "💬", title: "Async Triage", desc: "Clients submit photos and symptoms — your team triages and responds on their schedule" },
      { icon: "💊", title: "Remote Prescribing", desc: "Issue prescriptions during virtual visits with e-Rx to pharmacy or direct ship" },
      { icon: "📋", title: "Virtual Waiting Room", desc: "Branded waiting experience with estimated wait times and pre-visit intake" },
      { icon: "📊", title: "Telehealth Analytics", desc: "Track adoption, satisfaction scores, and revenue per virtual visit vs. in-clinic" },
    ],
    stat: { value: "3.2×", label: "ROI within 6 months for clinics offering virtual follow-ups" },
    cta: "Meet your clients where they are",
  },
  "MOD-ANL": {
    tagline: "Turn your practice data into your competitive advantage",
    color: "#8b5cf6",
    icon: "📊",
    highlights: [
      { icon: "❤️", title: "Practice Health Score", desc: "Single KPI combining revenue growth, client retention, appointment utilization, and staff efficiency" },
      { icon: "👥", title: "Client Retention Cohorts", desc: "Track new vs. returning clients, lapse risk scoring, and automated win-back campaigns" },
      { icon: "💰", title: "Revenue Intelligence", desc: "Per-vet, per-service, per-day revenue breakdowns with trend analysis and forecasting" },
      { icon: "📈", title: "Custom Report Builder", desc: "Drag-and-drop report creation with scheduling, PDF export, and email delivery" },
      { icon: "🏥", title: "Multi-Clinic Dashboards", desc: "Compare performance across locations with unified metrics and benchmarking" },
    ],
    stat: { value: "14%", label: "average revenue increase within 90 days of data-driven scheduling" },
    cta: "Stop guessing, start knowing",
  },
  "MOD-MAR": {
    tagline: "Build your reputation and fill your schedule automatically",
    color: "#06b6d4",
    icon: "📣",
    highlights: [
      { icon: "⭐", title: "Review Automation", desc: "Post-visit review requests via SMS — auto-routes happy clients to Google, unhappy ones to your team" },
      { icon: "📱", title: "Social Media Content", desc: "AI-generated social posts with pet photos, health tips, and seasonal campaigns" },
      { icon: "📧", title: "Email Marketing", desc: "Segmented campaigns for wellness reminders, birthday specials, and new service announcements" },
      { icon: "🎯", title: "Referral Rewards", desc: "Track client referrals, issue loyalty credits, and measure word-of-mouth ROI" },
      { icon: "📊", title: "Campaign Analytics", desc: "Track open rates, conversion, and revenue attribution for every campaign" },
    ],
    stat: { value: "4.8★", label: "average Google rating for clinics using automated review requests" },
    cta: "Let your happy clients do the marketing",
  },
  "MOD-STF": {
    tagline: "Your team is your greatest asset — manage it like one",
    color: "#f97316",
    icon: "👥",
    highlights: [
      { icon: "📅", title: "Staff Scheduling", desc: "Shift planning with availability tracking, swap requests, and overtime alerts" },
      { icon: "📚", title: "CE Tracking", desc: "Continuing education hours logged per staff member with renewal deadline alerts" },
      { icon: "🪪", title: "License Management", desc: "Track DEA, state, and specialty licenses with 90/60/30-day expiry warnings" },
      { icon: "📊", title: "Performance Metrics", desc: "Per-vet revenue, appointments per day, SOAP completion rates, and client satisfaction" },
      { icon: "⏱️", title: "Time & Attendance", desc: "Clock in/out with geofencing, break tracking, and payroll export integration" },
    ],
    stat: { value: "40%", label: "reduction in scheduling conflicts after implementation" },
    cta: "Retain your best people with better tools",
  },
  "MOD-REF": {
    tagline: "Seamless specialty referrals that close the loop",
    color: "#14b8a6",
    icon: "🔗",
    highlights: [
      { icon: "🏥", title: "Specialist Directory", desc: "Searchable database of local specialists with availability, turnaround times, and ratings" },
      { icon: "📝", title: "Referral Letter Generator", desc: "AI-drafted referral letters with patient history, diagnostics, and clinical rationale" },
      { icon: "🔄", title: "Bi-Directional Updates", desc: "Receive specialist reports back into your patient record automatically" },
      { icon: "📊", title: "Referral Analytics", desc: "Track referral patterns, specialist response times, and outcome data" },
      { icon: "🤝", title: "Network Building", desc: "Connect with local specialists and emergency clinics for preferred referral partnerships" },
    ],
    stat: { value: "2.1×", label: "faster specialist feedback with structured digital referrals" },
    cta: "Build the referral network your patients deserve",
  },
  "MOD-ENT": {
    tagline: "One platform, every location — unified ownership view",
    color: "#a855f7",
    icon: "🏢",
    highlights: [
      { icon: "🌐", title: "Multi-Location Ownership", desc: "Centralized dashboard across all clinic locations with consolidated P&L and KPIs" },
      { icon: "📊", title: "Cross-Clinic Benchmarking", desc: "Compare locations on revenue, utilization, client satisfaction, and operational efficiency" },
      { icon: "🔐", title: "SSO & Role Management", desc: "Single sign-on with granular role-based permissions across locations and departments" },
      { icon: "📦", title: "Centralized Procurement", desc: "Group purchasing across locations for volume discounts and unified supplier relationships" },
      { icon: "📈", title: "Consolidation Reporting", desc: "Board-ready reports with multi-entity financial consolidation and trend analysis" },
    ],
    stat: { value: "30%", label: "operational cost reduction through centralized procurement" },
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(290px,1fr))", gap: "12px" }}>
        {modules.map(mod => {
          ...
          const isExpanded = expanded === mod.module_id;
          const mkt = MODULE_MARKETING[mod.module_id];
          const accentColor = mkt?.color ?? "#6366f1";

          return (
            <Card key={mod.module_id} style={{
              borderColor: active ? `${accentColor}55` : "rgba(63,63,70,0.3)",
              background: active ? `${accentColor}08` : "rgba(24,24,27,0.7)",
              transition: "all 0.3s ease",
              gridColumn: isExpanded ? "1 / -1" : undefined,
            }}>
              {/* Header — always visible */}
              <div
                onClick={() => setExpanded(isExpanded ? null : mod.module_id)}
                style={{ cursor: "pointer" }}
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                    {mkt && <span style={{ fontSize: "1.4rem" }}>{mkt.icon}</span>}
                    <div>
                      <p style={{ margin: 0, fontWeight: 700, fontSize: "0.88rem", color: "#e4e4e7" }}>{mod.name}</p>
                      <p style={{ margin: "2px 0 0", fontSize: "0.68rem", color: "#52525b", textTransform: "uppercase", letterSpacing: "0.05em" }}>{mod.module_id}</p>
                    </div>
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    ...
                    <span style={{ color: "#52525b", fontSize: "0.75rem", transition: "transform 0.2s ease", display: "inline-block", transform: isExpanded ? "rotate(180deg)" : "rotate(0)" }}>▼</span>
                  </div>
                </div>
                <p style={{ margin: "0 0 10px", fontSize: "0.78rem", color: "#71717a", lineHeight: 1.5 }}>{mod.description}</p>
              </div>

              {/* Price + action row — always visible */}
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ color: accentColor, fontWeight: 700, fontSize: "0.85rem" }}>{fmtCents(mod.price_cents)}</span>
                {active ? (
                  <button
                    onClick={(e) => { e.stopPropagation(); deactivate(mod.module_id); }}
                    disabled={isLoading}
                    style={{
                  ...
                  <button
                    onClick={(e) => { e.stopPropagation(); if (!planLocked) activate(mod.module_id); }}
                    disabled={isLoading || planLocked}
                    title={planLocked ? `Requires ${mod.tier_required} plan` : undefined}
                    style={{
                      padding: "5px 12px", borderRadius: "7px", fontSize: "0.72rem", fontWeight: 600,
                      background: planLocked ? "rgba(63,63,70,0.2)" : `${accentColor}22`,
                      border: `1px solid ${planLocked ? "rgba(63,63,70,0.3)" : `${accentColor}44`}`,
                      color: planLocked ? "#52525b" : accentColor,
              ...
              {isExpanded && mkt && (
                <div style={{
                  ...
                  {/* Tagline */}
                  <p style={{
                    margin: "0 0 16px", fontSize: "1.05rem", fontWeight: 700,
                  ...
                  <div style={{
                    ...
                    {mkt.highlights.map((h, i) => (
                      <div key={i} style={{
                        ...
                        onMouseEnter={e => { e.currentTarget.style.background = `${accentColor}14`; e.currentTarget.style.borderColor = `${accentColor}30`; }}
                        onMouseLeave={e => { e.currentTarget.style.background = `${accentColor}08`; e.currentTarget.style.borderColor = `${accentColor}18`; }}
                      >
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
                          <span style={{ fontSize: "1rem" }}>{h.icon}</span>
                          <span style={{ fontWeight: 700, fontSize: "0.8rem", color: "#e4e4e7" }}>{h.title}</span>
                        </div>
                        <p style={{ margin: 0, fontSize: "0.73rem", color: "#a1a1aa", lineHeight: 1.5 }}>{h.desc}</p>
                      </div>
                    ))}
                  </div>
                  ...
                  <div style={{
                    ...
                    <div>
                      <span style={{ fontSize: "1.6rem", fontWeight: 800, color: accentColor }}>{mkt.stat.value}</span>
                      <span style={{ fontSize: "0.75rem", color: "#a1a1aa", marginLeft: "8px" }}>{mkt.stat.label}</span>
                    </div>
                    <div style={{
